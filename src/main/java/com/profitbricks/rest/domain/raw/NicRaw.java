 ...
 * @author jasmin.gacic
 */
public class NicRaw extends ProfitbricksBaseRaw {
   ...
   public class Entities {
      ...
      private FirewallRulesRaw firewallrules = new FirewallRulesRaw();

      /**
       * @return the firewallrules
       */
      public FirewallRulesRaw getFirewallrules() {
       ...
       */
      public void setFirewallrules(FirewallRulesRaw firewallrules) {
