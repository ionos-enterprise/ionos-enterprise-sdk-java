...
public class Helper {
    ...
    public static Volume convertVolume(VolumeRaw v) {
        ...
        toReturn.setType(v.getProperties().getType());
        ...
        toReturn.setSshKeys(v.getProperties().getSshKeys());
        toReturn.setImagePassword(v.getProperties().getImagePassword());
        toReturn.setCpuHotPlug(v.getProperties().getCpuHotPlug());
        toReturn.setCpuHotUnplug(v.getProperties().getCpuHotUnplug());
        toReturn.setRamHotPlug(v.getProperties().getRamHotPlug());
        toReturn.setRamHotUnplug(v.getProperties().getRamHotUnplug());
        toReturn.setNicHotPlug(v.getProperties().getNicHotPlug());
        toReturn.setNicHotUnplug(v.getProperties().getNicHotUnplug());
        toReturn.setDiscVirtioHotPlug(v.getProperties().getDiscVirtioHotPlug());
        toReturn.setDiscVirtioHotUnplug(v.getProperties().getDiscVirtioHotUnplug());
        toReturn.setDiscScsiHotPlug(v.getProperties().getDiscScsiHotPlug());
        toReturn.setDiscScsiHotUnplug(v.getProperties().getDiscScsiHotUnplug());
